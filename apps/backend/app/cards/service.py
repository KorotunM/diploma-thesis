        ...
        for index, field_name in enumerate(program_fields):
            ...
            responses.append(
                AdmissionProgramResponse(
                    ...
                    paid_places=self._int_value(program.get("paid_places")),
                    passing_score=self._int_value(program.get("passing_score")),
                    tuition_per_year=self._int_value(program.get("tuition_per_year")),
                    ...
                    exams=self._list_of_dicts(program.get("exams")),
