...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_university_canonical_name_trgm", "university", ["canonical_name"], schema="core",
    ...
    op.create_index("idx_delivery_search_text", "university_card", ["search_text"], schema="delivery", postgresql_using="gin")
    op.create_index("idx_university_search_doc_search_text", "university_search_doc", ["search_text"], schema="delivery", postgresql_using="gin")
    op.create_index(
        "idx_university_search_doc_canonical_name_trgm", "university_search_doc", ["canonical_name"], schema="delivery",
        postgresql_using="gin", postgresql_ops={"canonical_name": "gin_trgm_ops"},
    )
